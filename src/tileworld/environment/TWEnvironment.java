...
import tileworld.agent.impl.ProbabilityBasedTWAgent;
...
public class TWEnvironment extends SimState implements Steppable {
    ...
    public void start() {
        ...
        TWAgent agent1 = new ProbabilityBasedTWAgent(0, 0, this, Parameters.defaultFuelLevel);
        TWAgent agent2 = new ProbabilityBasedTWAgent(1, 1, this, Parameters.defaultFuelLevel);
        
        agents.add(agent1);
        agents.add(agent2);
        
        createAgent(agent1,2);
        createAgent(agent2,3);
